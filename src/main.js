...
const translations = {
  ru: {
    ...
    'account-login-title': 'Вы не вошли в аккаунт',
    'account-login-desc':
      'Войдите, чтобы занять юзернейм, подписываться на друзей и синхронизировать плейлисты.',
    'account-login-btn': 'Войти',
    'account-guest-title': 'Вы — гость',
    'account-guest-desc':
      'Гостевой профиль живёт только на этом устройстве. Создайте постоянный аккаунт, чтобы занять юзернейм и добавлять друзей.',
    'account-create-btn': 'Создать аккаунт',
    'account-guest-name': 'Гость',
    'account-guest-handle': 'гостевой режим',
    'account-no-username': 'без юзернейма',
    'account-no-username-set': 'Юзернейм не занят',
    'account-claim-username': 'Занять юзернейм',
    'account-edit-profile': 'Редактировать профиль',
    'account-private': 'Приватный',
    'account-settings': 'Настройки',
    'account-share': 'Поделиться',
    'account-copy': 'Скопировать',
    'account-copied': 'Скопировано',
    'account-username-copied': 'Юзернейм скопирован',
    'account-logout': 'Выйти из аккаунта',
    'account-back': 'Назад',
    'account-followers': 'подписчиков',
    'account-follower-1': 'подписчик',
    'account-follower-2': 'подписчика',
    'account-follower-5': 'подписчиков',
    'account-following-label': 'подписок',
    'account-sub-1': 'подписка',
    'account-sub-2': 'подписки',
    'account-sub-5': 'подписок',
    'account-followers-title': 'Подписчики',
    'account-following-title': 'Подписки',
    'account-list-empty': 'Пока пусто',
    'account-follow': 'Подписаться',
    'account-follow-btn': 'Подписаться',
    'account-following': 'Вы подписаны',
    'account-requested': 'Запрошено',
    'account-followed': 'Вы подписались',
    'account-request-sent': 'Заявка отправлена',
    'account-unfollowed': 'Подписка отменена',
    'account-remove': 'Удалить',
    'account-follower-removed': 'Подписчик удалён',
    'account-find-friends': 'Найти друзей',
    'account-search-ph': 'Юзернейм друга',
    'account-search-hint': 'Введите минимум 2 символа юзернейма',
    'account-searching': 'Ищем…',
    'account-search-empty': 'Никого не нашли',
    'account-it-is-you': 'Это вы',
    'account-requests': 'Заявки',
    'account-accept': 'Принять',
    'account-decline': 'Отклонить',
    'account-cancel-request': 'Отменить заявку',
    'account-request-accepted': 'Заявка принята',
    'account-friends': 'Друзья',
    'account-friends-empty': 'Пока нет взаимных подписок — найдите друзей по юзернейму выше',
    ...
    'account-play': 'Воспроизвести',
    'account-opened-playlist': 'Плейлист открыт',
    'account-friend-playlist': 'Плейлисты друзей пока только для просмотра',
    'account-social-off': 'Социальные функции недоступны',
    'account-social-off-desc': 'Не удалось связаться с сервером.',
    'account-offline': 'Офлайн-режим',
    'account-offline-desc': 'Нет соединения с Firebase: показаны локальные данные.',
    'account-user-not-found': 'Пользователь не найден',
    'account-saved': 'Изменения сохранены',
    'account-avatar-unsupported': 'Не удалось обработать изображение',
    'account-wait': '…',
    'account-username-empty': 'Придумайте юзернейм — он станет вашей ссылкой',
    'account-username-guest': 'Гостям недоступны юзернеймы',
    'account-username-checking': 'Проверяем…',
    'account-username-free': 'свободен',
    'account-cancel': 'Отмена',
    'account-save': 'Сохранить',
    'account-edit-title': 'Редактировать профиль',
    'account-change-photo': 'Изменить фото',
    'account-remove-photo': 'Удалить фото профиля',
    'account-name': 'Имя',
    'account-name-ph': 'Ваше имя',
    'account-username': 'Имя пользователя',
    'account-bio': 'О себе',
    'account-bio-ph': 'Расскажите о своём музыкальном вкусе…',
    'account-links': 'Ссылки',
    'account-link-connect': 'Подключить',
    'account-privacy': 'Приватность',
    'account-private-title': 'Приватный профиль',
    'account-private-desc': 'Ваши публичные плейлисты и статистика будут скрыты от посторонних',
  },
  en: {
    logo: 'Votify',
    'nav-home': 'Home',
    ...
    'account-login-title': 'You are not signed in',
    'account-login-desc': 'Sign in to claim a username, follow friends and sync playlists.',
    'account-login-btn': 'Sign in',
    'account-guest-title': 'You are a guest',
    'account-guest-desc':
      'Guest profiles live on this device only. Create a permanent account to claim a username and add friends.',
    'account-create-btn': 'Create account',
    'account-guest-name': 'Guest',
    ...
    'account-username-copied': 'Username copied',
    'account-logout': 'Sign out',
    'account-back': 'Back',
    'account-followers': 'followers',
    'account-follower-1': 'follower',
    'account-follower-2': 'followers',
    'account-follower-5': 'followers',
    'account-following-label': 'following',
    'account-sub-1': 'following',
    'account-sub-2': 'following',
    'account-sub-5': 'following',
    'account-followers-title': 'Followers',
    'account-following-title': 'Following',
    'account-list-empty': 'Nothing here yet',
    'account-follow': 'Follow',
    'account-follow-btn': 'Follow',
    'account-following': 'Following',
    'account-requested': 'Requested',
    'account-followed': 'Followed',
    'account-request-sent': 'Request sent',
    'account-unfollowed': 'Unfollowed',
    'account-remove': 'Remove',
    'account-follower-removed': 'Follower removed',
    'account-find-friends': 'Find friends',
    'account-search-ph': "Friend's username",
    'account-search-hint': 'Type at least 2 characters of the username',
    'account-searching': 'Searching…',
    'account-search-empty': 'Nobody found',
    'account-it-is-you': 'It’s you',
    'account-requests': 'Requests',
    'account-accept': 'Accept',
    'account-decline': 'Decline',
    'account-cancel-request': 'Cancel request',
    'account-request-accepted': 'Request accepted',
    'account-friends': 'Friends',
    'account-friends-empty': 'No mutual follows yet — find friends by username above',
    ...
    'account-play': 'Play',
    'account-opened-playlist': 'Playlist opened',
    'account-friend-playlist': 'Friends’ playlists are view-only for now',
    'account-social-off': 'Social features unavailable',
    'account-social-off-desc': 'Could not reach the server.',
    'account-offline': 'Offline mode',
    'account-offline-desc': 'No Firebase connection: showing local data.',
    'account-user-not-found': 'User not found',
    'account-saved': 'Changes saved',
    'account-avatar-unsupported': 'Could not process the image',
    'account-wait': '…',
    'account-username-empty': 'Pick a username — it becomes your link',
    'account-username-guest': 'Guests can’t claim usernames',
    'account-username-checking': 'Checking…',
    'account-username-free': 'available',
    'account-cancel': 'Cancel',
    'account-save': 'Save',
    'account-edit-title': 'Edit profile',
    'account-change-photo': 'Change photo',
    'account-remove-photo': 'Remove profile photo',
    'account-name': 'Name',
    'account-name-ph': 'Your name',
    'account-username': 'Username',
    'account-bio': 'About',
    'account-bio-ph': 'Tell about your music taste…',
    'account-links': 'Links',
    'account-link-connect': 'Connect',
    'account-privacy': 'Privacy',
    'account-private-title': 'Private profile',
    'account-private-desc': 'Your public playlists and stats will be hidden from strangers',
  },
};
...
const screenPageTitles = {
  ...
  'account-screen': 'Аккаунт',
  'account-edit-screen': 'Редактировать профиль',
};
...
function switchScreen(screenId, activeBtnId) {
  ...
  if (screenId === 'account-screen' && window.VotifyAccount) {
    window.VotifyAccount.render();
  }
